...
#     done
#     if [[ "$revz" == "$z" ]]; then
#        echo $revz eh palindromo
#        echo $revz >> resultadotodospalindos9.txt
#     fi
#     revz=""
# done
...
# filename="/home/fernando/resultadotodospalindos9.txt"
# while read -r line 
# do # (( j in $(cat resultadotodospalindos9.txt); j<=n/2; )) ; 
#   for (( i=2;i<=line/2;i++ ));
#     do 
...
#   done
#   if [ $prime_1 -eq 1 ] ; then 
#     echo $line 2>&1 | tee -a resultadotodospalindos9primos.txt
#   fi
# done<"$filename"